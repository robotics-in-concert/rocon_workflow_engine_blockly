...
var Ros = function(opts){
  ...
  var retry_op = Utils.retry(function(){
    logger.info('trying to connect to ros ' + process.env.ROCON_WORKFLOW_ENGINE_BLOCKLY_ROSBRIDGE_URL);
    var connected = false;
    ...
    ros.connect(process.env.ROCON_WORKFLOW_ENGINE_BLOCKLY_ROSBRIDGE_URL);
